...
const Atividade2 = () => {
    const [letters, setLetters] = useState([
      ...
      const [letters2, setLetters2] = useState([
        { letter2: 'T', highlighted: false },
        { letter2: 'L', highlighted: false },
        { letter2: 'N', highlighted: false },
      ...
      return (
        <div className='container-atividade'>       
            ...
            <div style={{display:'flex', color:'black'}}>
              <h1 style={{color:'black', fontSize:'50px'}}> A B _ </h1>
            </div>
            ...
            <div style={{display:'flex', color:'black'}}>
              <h1 style={{color:'black', fontSize:'50px'}}> L M _ </h1>
            </div>
            <div style={{marginTop:'50px'}}>
                ...
                <span
                    ...
                    style={{ marginRight: '5px', fontSize: '50px', backgroundColor: letter2.highlighted ? 'yellow' : '#f4f4f4', cursor:"pointer"}}
                >
                    {letter2.letter2}
                </span>
                ))}
            </div> 
            {(allAsHighlighted && allAsHighlighted2) && <div className='winnable5'></div>}
        </div>
    );
};
